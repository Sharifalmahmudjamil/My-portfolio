...
const MyProjects = () => {
  return (
    <div>
       <div name="projects" className="bg-slate-950 ">
        ...
        <div>
            <img src='https://i.ibb.co/LnCn7SK/contact.jpg' />
                    ...
                    <div className="card-body">
                        ...
                        <img src={tailwind} alt="html" className='w-[30px] h-[30px]' />
                        <img src={react} alt="html" className='w-[30px] h-[30px]' />
                        <img src={node} alt="html" className='w-[30px] h-[30px]' />
                        <img src={mongo} alt="html" className='w-[30px] h-[30px]' />
